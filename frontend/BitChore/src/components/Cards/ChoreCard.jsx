...
const ChoreCard = ({ title, description, priority, status, progress, createdAt, dueDate, assignedTo, attachmentCount, completedTodoCount, todoChecklist, onClick }) => {
    ...
    >
        ...
        <div
            className={`px-4 border-l-[3px] ${ status === "In Progress" ? "border-[#C499F3]/30" : status === "Completed" ? "border-[#33186B]/20" : "border-[#F2AFEF]/40" }`}
        >
